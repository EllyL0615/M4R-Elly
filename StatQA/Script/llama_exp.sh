...
wait
python Evaluation/llama_evaluation.py --model_type "deepseek" --dataset_name "mini-StatQA" --trick "zero-shot"

wait
python Evaluation/llama_evaluation.py --model_type "deepseek" --dataset_name "mini-StatQA" --trick "one-shot"

wait
python Evaluation/llama_evaluation.py --model_type "deepseek" --dataset_name "mini-StatQA" --trick "zero-shot-CoT"

wait
python Evaluation/llama_evaluation.py --model_type "deepseek" --dataset_name "mini-StatQA" --trick "one-shot-CoT"

wait
python Evaluation/llama_evaluation.py --model_type "deepseek" --dataset_name "mini-StatQA" --trick "stats-prompt"
